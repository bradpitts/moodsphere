...
enum GalaxyViewMode { sphere, constellation }
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  GalaxyViewMode _viewMode = GalaxyViewMode.sphere;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Background View Engine
            Positioned.fill(
              child: _viewMode == GalaxyViewMode.sphere
                  ? Native3DSphere(
                      entries: entries,
                      onEntryTap: (entry) {
            ...
            Positioned.fill(
              child: Column(
                children: [
                  ...
                  // Mode Toggle Button (Sphere vs Constellation)
                  Align(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            _buildToggleOption(
                              label: '3D Sphere',
                              isSelected: _viewMode == GalaxyViewMode.sphere,
                              onTap: () => setState(() => _viewMode = GalaxyViewMode.sphere),
                            ),
                            _buildToggleOption(
                              label: 'Constellation',
                              isSelected: _viewMode == GalaxyViewMode.constellation,
                              onTap: () => setState(() => _viewMode = GalaxyViewMode.constellation),
                            ),
                          ],
                        ),
                      ),
